...
const translations = {
    'zh-TW': {
        ...
        tut_canvas: '建立共用畫布',
        tut_md: '開關 Markdown',
        tut_create_commands: '建立新房間指令',
        tut_search_commands: '🔍 搜尋框指令',
        tut_join_lock: '加入或建立話題 (帶密碼即可建立上鎖房)',
        tut_hot: '熱門話題',
        tut_lock_only: '僅顯示密碼保護房',
        tut_open_only: '僅顯示公開房間',
        tut_admin_commands: '🛡️ 管理權限指令',
        tut_admin_newname: '新名稱',
        tut_admin_rename_desc: '更改本房在大廳顯示的標題',
        tut_admin_public_desc: '開放房間讓所有人直接加入',
        tut_admin_private_desc: '設定密碼鎖，限制進入',
        tut_admin_password: '密碼',
        tut_admin_clear_desc: '清空本房的聊天紀錄',
        tut_admin_delete_desc: '立即關閉並刪除此房間',
        tut_admin_id: 'ID',
        tut_admin_ban_desc: '封鎖並踢出特定匿名 ID',
        tut_admin_title: '標題',
        tut_admin_content: '內容',
        tut_admin_announce_desc: '發布全站公告讓大家都看到',
        ...
        room_cleared: '🧹 本房聊天紀錄已清空。',
        room_deleted: '⚠️ 房間已被刪除，返回大廳。',
        room_renamed: '✏️ 房間名稱已更新為 {name}。',
        room_banned: '😢 你已被本房管理員封鎖，無法再次加入。',
        room_name_taken: '❌ 房間名稱已存在，請換一個。',
        room_create_failed: '❌ 無法建立房間，請稍後再試。',
        room_not_found: '❌ 找不到該房間。',
        thread_prompt: '請為討論串輸入標題：',
        thread_default_title: '新討論串',
        thread_button: '🧵 前往討論串',
        thread_parent_label: '此為子討論串，原房：',
        thread_back: '返回主頻道',
        menu_thread: '🧵 開啟討論串',
    ...
    'zh-CN': {
        ...
        tut_canvas: '建立共享画布',
        tut_md: '开关 Markdown',
        tut_create_commands: '新建房间指令',
        tut_search_commands: '🔍 搜索框指令',
        tut_join_lock: '加入或创建话题 (带密码即可创建上锁房)',
        tut_hot: '热门话题',
        tut_lock_only: '仅显示密码保护房',
        tut_open_only: '仅显示公开房间',
        tut_admin_commands: '🛡️ 管理权限指令',
        tut_admin_newname: '新名称',
        tut_admin_rename_desc: '更改本房在大厅显示的标题',
        tut_admin_public_desc: '开放房间让所有人直接加入',
        tut_admin_private_desc: '设置密码锁，限制进入',
        tut_admin_password: '密码',
        tut_admin_clear_desc: '清空本房的聊天记录',
        tut_admin_delete_desc: '立即关闭并删除此房间',
        tut_admin_id: 'ID',
        tut_admin_ban_desc: '封锁并踢出特定匿名 ID',
        tut_admin_title: '标题',
        tut_admin_content: '内容',
        tut_admin_announce_desc: '发布全站公告让大家看到',
        ...
        room_cleared: '🧹 本房聊天记录已清空。',
        room_deleted: '⚠️ 房间已被删除，返回大厅。',
        room_renamed: '✏️ 房间名称已更新为 {name}。',
        room_banned: '😢 你已被本房管理员封锁，无法再次加入。',
        room_name_taken: '❌ 房间名称已存在，请换一个。',
        room_create_failed: '❌ 无法建立房间，请稍后再试。',
        room_not_found: '❌ 找不到该房间。',
        thread_prompt: '请为讨论串输入标题：',
        thread_default_title: '新讨论串',
        thread_button: '🧵 前往讨论串',
        thread_parent_label: '此为子讨论串，原房：',
        thread_back: '返回主频道',
        menu_thread: '🧵 开启讨论串',
    ...
    'en': {
        ...
        tut_create_commands: 'Room Creation Commands',
        ...
        tut_admin_commands: '🛡️ Admin Controls',
        tut_admin_newname: 'new name',
        tut_admin_rename_desc: 'Update this room’s lobby title',
        tut_admin_public_desc: 'Open the room so anyone can join',
        tut_admin_private_desc: 'Add a password lock to restrict entry',
        tut_admin_password: 'password',
        tut_admin_clear_desc: 'Clear all messages in this room',
        tut_admin_delete_desc: 'Close and delete this room immediately',
        tut_admin_id: 'ID',
        tut_admin_ban_desc: 'Ban and kick a specific anonymous ID',
        tut_admin_title: 'title',
        tut_admin_content: 'content',
        tut_admin_announce_desc: 'Post a site-wide announcement',
        ...
        room_cleared: '🧹 Room history cleared.',
        room_deleted: '⚠️ Room deleted, returning to the lobby.',
        room_renamed: '✏️ The room has been renamed to {name}.',
        room_banned: '😢 You have been banned from this room.',
        room_name_taken: 'Room name already exists; please pick another.',
        room_create_failed: 'Unable to create room. Please try again later.',
        room_not_found: 'Room not found.',
        thread_prompt: 'Enter a title for the thread:',
        thread_default_title: 'New thread',
        thread_button: '🧵 Open thread',
        thread_parent_label: 'Thread parent room:',
        thread_back: 'Back to the main room',
        menu_thread: '🧵 Start thread',
    ...
    'ja': {
        ...
        tut_create_commands: 'ルーム作成コマンド',
        tut_search_commands: '🔍 検索コマンド',
        tut_join_lock: 'トピックに参加または作成 (パスワードでロック)',
        tut_hot: '人気のトピック',
        tut_lock_only: 'ロックされたルームのみ表示',
        tut_open_only: '公開ルームのみ表示',
        tut_admin_commands: '🛡️ 管理権限コマンド',
        tut_admin_newname: '新しい名前',
        tut_admin_rename_desc: 'ロビーの表示タイトルを変更',
        tut_admin_public_desc: '誰でも参加できる公開にする',
        tut_admin_private_desc: 'パスワードで入室制限',
        tut_admin_password: 'パスワード',
        tut_admin_clear_desc: 'このルームの履歴を全削除',
        tut_admin_delete_desc: 'ルームを即時閉鎖・削除',
        tut_admin_id: 'ID',
        tut_admin_ban_desc: '特定の匿名IDを封鎖',
        tut_admin_title: 'タイトル',
        tut_admin_content: '内容',
        tut_admin_announce_desc: '全体通知を投稿',
        ...
        room_cleared: '🧹 履歴が削除されました。',
        room_deleted: '⚠️ ルームが削除され、ロビーに戻ります。',
        room_renamed: '✏️ ルーム名を{name}に更新しました。',
        room_banned: '😢 このルームから封鎖されています。',
        room_name_taken: '❌ ルーム名が既に使用されています。別の名前にしてください。',
        room_create_failed: '❌ ルームを作成できませんでした。しばらくしてから再試行してください。',
        room_not_found: '❌ ルームが見つかりません。',
        thread_prompt: 'スレッドのタイトルを入力してください：',
        thread_default_title: '新しいスレッド',
        thread_button: '🧵 スレッドへ',
        thread_parent_label: 'このスレッドの親ルーム：',
        thread_back: 'メインルームに戻る',
        menu_thread: '🧵 スレッドを開く',
    ...
    'ko': {
        ...
        tut_create_commands: '룸 생성 명령어',
        tut_search_commands: '🔍 검색창 명령어',
        tut_join_lock: '주제 참여 또는 생성 (비밀번호로 잠금)',
        tut_hot: '인기 주제',
        tut_lock_only: '잠긴 방만 표시',
        tut_open_only: '공개 방만 표시',
        tut_admin_commands: '🛡️ 관리자 명령어',
        tut_admin_newname: '새 이름',
        tut_admin_rename_desc: '로비에 표시되는 제목을 바꿉니다',
        tut_admin_public_desc: '누구나 참여할 수 있도록 공개화',
        tut_admin_private_desc: '비밀번호로 입장 제한',
        tut_admin_password: '비밀번호',
        tut_admin_clear_desc: '이 방의 기록을 초기화합니다',
        tut_admin_delete_desc: '방을 즉시 종료하고 삭제',
        tut_admin_id: 'ID',
        tut_admin_ban_desc: '특정 익명 ID를 차단',
        tut_admin_title: '제목',
        tut_admin_content: '내용',
        tut_admin_announce_desc: '전체 공지를 게시합니다',
        ...
        room_cleared: '🧹 채팅 기록이 초기화되었습니다.',
        room_deleted: '⚠️ 방이 삭제되어 로비로 이동합니다.',
        room_renamed: '✏️ 방 이름이 {name}(으)로 변경되었습니다.',
        room_banned: '😢 이 방에서 차단되었습니다.',
        room_name_taken: '❌ 방 이름이 이미 존재합니다. 다른 이름을 선택하세요.',
        room_create_failed: '❌ 방을 만들 수 없습니다. 나중에 다시 시도해주세요.',
        room_not_found: '❌ 방을 찾을 수 없습니다.',
        thread_prompt: '스레드 제목을 입력하세요:',
        thread_default_title: '새 스레드',
        thread_button: '🧵 스레드로 이동',
        thread_parent_label: '이 스레드의 부모방:',
        thread_back: '기본 채팅방으로 돌아가기',
        menu_thread: '🧵 스레드 열기',
    ...
    'vi': {
        ...
        tut_create_commands: 'Lệnh tạo phòng',
        ...
        tut_admin_commands: '🛡️ Lệnh quản trị',
        tut_admin_newname: 'tên mới',
        tut_admin_rename_desc: 'Cập nhật tiêu đề hiển thị trong sảnh',
        tut_admin_public_desc: 'Mở phòng cho mọi người gia nhập',
        tut_admin_private_desc: 'Khóa phòng bằng mật khẩu',
        tut_admin_password: 'mật khẩu',
        tut_admin_clear_desc: 'Xóa lịch sử của phòng này',
        tut_admin_delete_desc: 'Đóng và xóa phòng ngay lập tức',
        tut_admin_id: 'ID',
        tut_admin_ban_desc: 'Chặn một ID ẩn danh cụ thể',
        tut_admin_title: 'tiêu đề',
        tut_admin_content: 'nội dung',
        tut_admin_announce_desc: 'Đăng thông báo toàn hệ thống',
        ...
        room_cleared: '🧹 Đã xóa lịch sử phòng.',
        room_deleted: '⚠️ Phòng đã bị xóa, đang quay lại sảnh.',
        room_renamed: '✏️ Phòng đã đổi tên thành {name}.',
        room_banned: '😢 Bạn đã bị chặn khỏi phòng này.',
        room_name_taken: '❌ Tên phòng đã tồn tại, hãy đổi sang tên khác.',
        room_create_failed: '❌ Không thể tạo phòng, hãy thử lại sau.',
        room_not_found: '❌ Không tìm thấy phòng.',
        thread_prompt: 'Nhập tiêu đề cho luồng thảo luận:',
        thread_default_title: 'Luồng thảo luận mới',
        thread_button: '🧵 Đi tới luồng',
        thread_parent_label: 'Luồng phụ thuộc phòng:',
        thread_back: 'Quay về phòng chính',
        menu_thread: '🧵 Tạo luồng mới',
